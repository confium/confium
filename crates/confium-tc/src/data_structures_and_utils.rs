...
impl TestFixtures {
    ...
    pub fn make_session_request(quorum: &str, threshold: u32, parties: u32) -> crate::coordinator::session::SessionRequest {
        crate::coordinator::session::SessionRequest {
            quorum_id: quorum.into(), scheme: "CMP20".into(),
            message: Self::random_message(), threshold, num_parties: parties,
            unlock_window_minutes: 60, requested_by: "test-factory".into(),
        }
    }
