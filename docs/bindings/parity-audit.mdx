...
Where to use which language. Feature coverage per binding, including what's shipped, what's in progress, and what's not planned.
...
| ⏳ Tier 3 — Planned | On the roadmap, not yet started |
| ❌ Tier 4 — Not Planned | Out of scope for current release |
...
- API: <https://docs.rs/confium-{product}>
