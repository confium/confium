---
title: Conventions
description: The conventions every Confium crate follows — lints, edition 2024 quirks, error handling, trait design, testing.
---
...
| `.map_err(\|e\| { ...; e })` | `.inspect_err(\|_e| { ... })` for side-effect-only error inspection. |
