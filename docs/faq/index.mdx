...
Confium's privacy surface uses specific primitives (PSI, PIR, DP, MPC) that are dramatically faster than general FHE. FHE (`confium-tc-fhe-bfv`) is research-grade and out of scope for v1.0 — see the [long-term plan](https://github.com/confium/confium/blob/main/ROADMAP.md).
