...
|------|-------|------------|-----------|
| `confium-tc` re-exports (use `confium-tc-core` / `confium-coordinator` / `confium-tc-keys` directly) | 0.4 (in progress) | 0.6 (in progress) | [0.3 → 0.4 migration](../migrations/0.3-to-0.4.mdx) |
